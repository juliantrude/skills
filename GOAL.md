...
STATUS: READY
**Next action:** Add hash-based routing (`#/`, `#/plan`, `#/logs`) with a persistent nav in `app.html`/`app.js` (Routing and pages, 1st increment). No server-side route changes; the existing `/api/*` endpoints stay as they are.
**Blockers:** none
