...
STATUS: READY
**Next action:** Build the **home** screen: status headline, current task, next task, overall plan progress, session and week budget — no log output on this page at all (Routing and pages, 2nd increment). The three sections already exist from the routing increment; this is about curating what home shows vs. deferring to /plan.
**Blockers:** none
